                      ...
                      <div className="p-3 rounded-xl bg-white/5 border border-white/10 space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-white/40 mt-1">One rule per line for how Co-Work should weigh your work.</p>
                          </div>
                        </div>
                        <GlassTextarea
                          rows={4}
                      ...
                      <div className="p-3 rounded-xl bg-white/5 border border-white/10 space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-white/40 mt-1">Choose the time blocks Co-Work should prefer when planning meetings.</p>
                          </div>
                        </div>
                      ...
                      <div className="p-3 rounded-xl bg-white/5 border border-white/10 space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-white/40 mt-1">Comma-separated addresses Co-Work should recognize quickly.</p>
                          </div>
                        </div>
                        <GlassTextarea
                          rows={3}
                      ...
                      <div className="p-3 rounded-xl bg-white/5 border border-white/10 space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-white/40 mt-1">Controls what Co-Work treats as worth surfacing proactively.</p>
                          </div>
                        </div>
